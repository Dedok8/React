import { useGetDoctorsByIdQuery } from "@/api";
  ...
  return (
    <div className="max-w-3xl mx-auto my-8 p-6 bg-white shadow-lg rounded-2xl">
      ...
      <div className="space-y-2">
        ...
        <p>
          <span className="font-semibold text-gray-700">Спеціалізація:</span>{" "}
          {item.specialty}
        </p>
        <p>
        ...
        <p>
          <span className="font-semibold text-gray-700">Кабінет:</span>{" "}
          {item.room}
        </p>
        <p>
